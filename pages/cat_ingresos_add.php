...
include('../dist/includes/dbcon.php');
	...
	$query2=mysqli_query($con,"select * from categoria_ingresos where nombre='$nombre'")or die(mysqli_error($con));
		...
		mysqli_query($con,"INSERT INTO categoria_ingresos(nombre)
