...
?>
            ...
            <?php echo ($num > 0) ? '<a href="Clientes.php" class="small-box-footer">Mas info<i class="fa fa-arrow-circle-right"></i></a>' : '<a href="#" class="small-box-footer">-------</a>'; ?>
          </div>
        </div>
    <?php
                      }
...
$num=1;
    $query=mysqli_query($con,"select * from reparacion ")or die(mysqli_error());
    $i=0;
    while($row=mysqli_fetch_array($query)){
    $num++;
  }
...
?>
            ...
            <?php echo ($num > 0) ? '<a href="reparacion.php" class="small-box-footer">Mas info<i class="fa fa-arrow-circle-right"></i></a>' : '<a href="#" class="small-box-footer">-------</a>'; ?>
          </div>
        </div>
...
?>
            ...
            <?php echo ($num > 0) ? '<a href="gastos.php" class="small-box-footer">Mas info<i class="fa fa-arrow-circle-right"></i></a>' : '<a href="#" class="small-box-footer">-------</a>'; ?>
          </div>
        </div>
...
$num=0;
    $query=mysqli_query($con,"select * from ingresos ")or die(mysqli_error());
    $i=0;
    while($row=mysqli_fetch_array($query)){
    $num=$row['cantidad']+$num;
  }
...
?>
            ...
            <?php echo ($num > 0) ? '<a href="ingresos.php" class="small-box-footer">Mas info<i class="fa fa-arrow-circle-right"></i></a>' : '<a href="#" class="small-box-footer">-------</a>'; ?>
          </div>
        </div>
...
<?php
$num=0;
    $query=mysqli_query($con,"select * from parte ")or die(mysqli_error());
    $i=0;
    while($row=mysqli_fetch_array($query)){
    $num++;
  }
...
?>
              ...
              <p>Partes / repuestos</p>
            </div>
            <div class="icon"><img height="80" width="80" src="img/productos.png">
              <i class=""></i>
            </div>
            <?php echo ($num > 0) ? '<a href="parte.php" class="small-box-footer">Mas info<i class="fa fa-arrow-circle-right"></i></a>' : '<a href="#" class="small-box-footer">-------</a>'; ?>
          </div>
        </div>
