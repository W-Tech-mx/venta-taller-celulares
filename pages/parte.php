...
#buscar{
 ...
 <!--end of modal-->
                        <div class="box-body">
                  <!-- Date range -->
                  <form method="post" action="parte_add.php" enctype="multipart/form-data" class="form-horizontal">
...
<div class="row">
                    <div class="col-md-3 btn-print">
                      <div class="form-group">
                       ...
                       <div class="col-md-4 btn-print">
                      <div class="form-group">
            <input type="text" class="form-control" id="stock" name="stock" min="0" placeholder="Stock" style="width: : 100%;" onkeypress='return event.charCode >= 48 && event.charCode <= 57' required>
                      </div>
                    </div>
                           <div class="col-md-4 btn-print">
    ...
    <button type="submit" class="btn btn-primary">Guardar cambios</button>
              ...
              <!-- /.input group -->
                  ...
                  <h3 class="box-title"> Lista partes</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
...
<td><?php echo $row['stock'];?></td>
                        ...
                        <td>
<a class="small-box-footer btn-print" href="<?php  echo "eliminar_parte.php?id_pro=$id_pro";?>" onclick="return confirm('¿Está seguro de que desea eliminar este producto??');"" > <i class="glyphicon glyphicon-remove"></i></a>
  ...
  <div class="modal-dialog" style="width: 900px; height: 900px;">
    <div class="modal-content" style="height:auto">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Actualizar los detalles del partes</h4>
              </div>
              <div class="modal-body" style="width: 100%; height: 100%;">
        <form class="form-horizontal" method="post" action="parte_actualizar.php" enctype='multipart/form-data'>
...
<div class="col-md-12 btn-print">
               ...
               <div class="form-group">
          <label class="control-label col-lg-3" for="price">nombre parte</label><br>
