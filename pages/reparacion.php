...
$cont=0;
$id_pedido="";
            $query3=mysqli_query($con,"select * from reparacion ")or die(mysqli_error());
...
?>
 ...
 <!--end of modal-->
   ...
   <?php
$cliente=0;
            $query6=mysqli_query($con,"select * from temporal_cliente  where id_temporal='1' ")or die(mysqli_error());
...
?>
                ...
                <div class="box-body">
                  ...
                  <form method="post" action="reparacion_add.php" enctype="multipart/form-data" class="form-horizontal">
...
<div class="row">
                    <div class="col-md-3 btn-print">
                      <div class="form-group">
                       ...
                       <div class="col-md-4 btn-print">
                      <div class="form-group">
                    <input type="text" class="form-control" id="costo_mano_obra" name="costo_mano_obra"  value="0" >
                      </div>
                    </div>
                           <div class="col-md-4 btn-print">
...
<table class="table table-striped" id="table_servicios">
   ...
   // $branch=$_SESSION['branch'];
    $query=mysqli_query($con,"select * from parte where stock>'0' ")or die(mysqli_error());
    $i=1;
...
?>
       <form action="reparacion_temporal_add.php" method="post">
        <input type="hidden" name="id_pedido" value="<?php echo $id_pedido; ?>">
         <tr>
                        ...
                        <td><?php echo $row['precio_venta'];?></td>
                            <td>    <input name="cantidad" type="number" min="0" max="<?php echo $row['stock']; ?>" id="cantidad" placeholder="cantidad" style="width: : 100%;" onkeypress='return event.charCode >= 48 && event.charCode <= 57'  required></td>
...
<a class="btn btn-danger btn-print" href="<?php  echo "temporal_add_cliente_parte.php?id_cliente=$id_cliente";?>"  role="button">SELECCIONAR</a>
             <?php
            //          }
                      ?>
...
<?php
   // $branch=$_SESSION['branch'];
    $query=mysqli_query($con,"select * from parte AS p
INNER JOIN temporal_parte AS t
...
<a class="small-box-footer btn-print" href="<?php  echo "eliminar_temporal_reparacion.php?id_temporal=$id_temporal";?>" onClick="return confirm('¿Está seguro de que desea eliminar este producto??');"" > <i class="glyphicon glyphicon-remove"></i></a>
...
<div id="updateordinance<?php echo $row['id_temporal'];?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog" ">
    <div class="modal-content" style="height:auto">
        ...
        <form class="form-horizontal" method="post" action="actualizar_temporal_reparacion.php" enctype='multipart/form-data'>
