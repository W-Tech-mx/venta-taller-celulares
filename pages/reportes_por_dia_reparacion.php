...
           </div>
           <div class="col-md-3">
             <form method="post" action="reportes_por_dia_reparacion.php" enctype="multipart/form-data" class="form-horizontal">
...
?>
   ...
   <?php
    ...
    $query=mysqli_query($con,"select * from reparacion  where  fecha ='$fecha'  ")or die(mysqli_error());
    $contador=0;
