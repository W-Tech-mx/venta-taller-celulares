...
           </div>
           <div class="col-md-3">
             <form method="post" action="reportes_por_fecha_reparacion.php" enctype="multipart/form-data" class="form-horizontal">
...
?>
   ...
   <?php
    ...
    $query=mysqli_query($con,"select * from reparacion  where  fecha >='$fecha_inicio' and fecha <='$fecha_final'  ")or die(mysqli_error());
    $contador=0;
...
?>
 ...
 <?php
    ...
    $query=mysqli_query($con,"select * from reparacion AS p
...
<td><?php echo $row['fecha'];?></td>
              <td><?php echo $row['nombre'];?></td>
                      ...
                      ?>
<a class="btn btn-danger btn-print" href="<?php  echo "generar_pdf_reparacion.php?num_pedido=$num_pedido";?>"     role="button">Ver comprobante</a>
